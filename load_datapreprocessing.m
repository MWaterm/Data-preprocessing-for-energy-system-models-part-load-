...
%% Options: 
path = '';% path of load input
name_load = '';% name of file with load; file with 3 columns: time, forecast, actual
sheet_load = ''; % name of sheet with load data 
name_holiday = ''; % list of holiday dates which have to be noted
sheet_holiday = ''; % name of sheet with holiday dates 

start_time = datetime('dd.MM.yy','Inputformat','dd.MM.yy','TimeZone','UTC'); %Timezone to capture time changes; Start date historical data
